            ...
            <form class="flex items-center">
                ...
                <div class="relative w-full">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                      <font-awesome-icon :icon="faMagnifyingGlass" class="w-5 h-5 text-gray-500 dark:text-gray-400"/>
...
<script setup lang="ts">
  ...
  const singleRow: TravelRow = {
    name: 'Japan',
    startDate: '01/01/2024',
    endDate: '12/01/2024',
    image: 'jp',
    description: 'lorem ipsum dorime',
    price: 1499,
    rating: 4
  };
